          ...
          <ul className="navigation clearfix">
            ...
            {/* <li className="dropdown">
              ...
              <ul>
                ...
                <li>
                  <Link href="tour-details">Servicios</Link>
                </li>
                <li>
                  <Link href="tour-guide">Nosotros</Link>
                </li>
              </ul>
              <div className="dropdown-btn">
                <span className="far fa-angle-down" />
            ...
            <li className="dropdown">
              ...
              <ul>
                <li>
                  <Link href="destination1">Convocatorias</Link>
                </li>
                <li>
                  <Link href="destination2">Cursos y Ofertas Académicas</Link>
                </li>
                {/* <li>
                  <Link href="destination-details">Ofertas Académicas</Link>
                </li> */}
              </ul>
              <div className="dropdown-btn">
                <span className="far fa-angle-down" />
            ...
            <li className="dropdown">
              ...
              <ul>
                <li>
                  <Link href="pricing">Gaceta</Link>
                </li>
                <li>
                  <Link href="faqs">Enlaces</Link>
                </li>
                {/* <li className="dropdown">
                  <a href="#">Gallery</a>
                  <ul>
                ...
                {/* <li>
                  <Link href="contact">Contact Usyjty</Link>
                </li> */}
                {/* <li>
            ...
            <div className="header-inner rel d-flex align-items-center">
              <div className="logo-outer">
                <div className="logo">
                  <Link href="/">
                    <img
                      src="assets/images/logos/logoTS.png"
                      alt="Logo"
                      title="Logo"
                    />
                  </Link>
              ...
              <div className="menu-btns py-10">
                ...
                >
                  <span data-hover="Book Now">INSCRIPCIONES</span>
          ...
          <ul className="sidebar-menu">
            ...
            <li className="dropdown">
              ...
              <ul style={activeLi("Pages")}>
                ...
                <li>
                  <Link href="contact">Contact Usgngfhgf</Link>
                </li>
                <li>
                  <Link href="404">404 Error</Link>
                </li>
            ...
            <div className="header-inner rel d-flex align-items-center">
              ...
              <div className="menu-btns py-10">
                <Link
                  ...
                  className="theme-btn style-two bgc-secondary"
                >
                  <span data-hover="Book Now">M@E</span>
                  <i className="fal fa-arrow-right" />
                </Link>
                {/* menu sidbar */}
                <div className="menu-sidebar" onClick={() => sidebarClick()}>
